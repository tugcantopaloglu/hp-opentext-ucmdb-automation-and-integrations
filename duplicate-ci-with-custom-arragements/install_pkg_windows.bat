...
echo ==============================================
echo Duplicate CI Merger - Offline Installer
echo ==============================================
echo.
...
pip install --no-index --find-links="%PKG_DIR%" requests urllib3
...
if %ERRORLEVEL% NEQ 0 (
    ...
    echo   pip install --no-index --find-links="%PKG_DIR%" --break-system-packages requests urllib3
    echo.
    echo Or create a virtual environment first:
    echo   python -m venv venv
    echo   venv\Scripts\activate
    echo   pip install --no-index --find-links="%PKG_DIR%" requests urllib3
    pause
    exit /b 1
)
...
python -c "import requests; import urllib3; print('requests:', requests.__version__); print('urllib3:', urllib3.__version__); print(); print('All packages installed successfully!')"

echo.
echo You can now run:
echo   python duplicate_ci_merge.py --help
echo.
pause
